...
**Tech Stack:** Go 1.26.6, GitHub Actions, PostgreSQL 16 with pgvector, Docker Buildx, GHCR, Syft SPDX SBOMs, Sigstore Cosign, GitHub artifact attestations, GitHub repository rulesets.
